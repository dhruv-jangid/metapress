...
function RouteComponent() {
  return (
    <section className="space-y-16 mt-8">
      <div className="flex flex-col lg:flex-row justify-between gap-16 lg:gap-0 p-6 md:p-12 mb-0">
        <div className="space-y-2 font-medium">
          <span className="text-sm tracking-tight text-primary">MY STEPS</span>
        ...
        <div className="space-y-4 md:space-y-8">
          <div className="w-3xs xl:w-xs text-balance tracking-tight text-primary">
            "I find my work fulfilling when insight, timing, and authenticity come together"
          </div>
      ...
      <div className="flex flex-col lg:flex-row overflow-hidden px-6 md:px-12">
        <div className="relative aspect-square w-full lg:w-1/2 border rounded-xl overflow-hidden">
          <Image
        ...
        <div className="flex flex-col justify-center p-4 2xl:p-0 2xl:pl-16 gap-2 lg:gap-4 w-full lg:w-1/2">
          ...
          <div className="leading-snug max-w-sm my-2">
            From the first spark of an idea to the final published piece, creativity drives
            everything I do. Each blog post is crafted through exploration, design, and a touch of
            innovation — blending storytelling with modern digital tools. I believe in
            experimenting, learning, and evolving with every article I write.
          </div>
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-16 lg:gap-0 px-6 md:px-12">
        <div className="space-y-2 font-medium">
          <span className="text-sm tracking-tight text-orange-500">MY TAKES</span>
          <div className="text-5xl xl:text-6xl tracking-tighter">
            Not just an IDE,
            <br />
            but a big family.
        ...
        <div className="space-y-4 md:space-y-8">
          <div className="w-3xs xl:w-xs text-balance tracking-tight text-orange-500">
            "The real magic happens when insight meets timing — and everything feels true to who I
            am"
          </div>
          <span className="text-sm font-semibold">DHRUV JANGID</span>
        </div>
      ...
      <div className="flex flex-col lg:flex-row items-end gap-4 w-full overflow-hidden">
        <Image
          ...
          alt="Pencil"
          layout="fullWidth"
          className="object-cover w-full h-96 xl:h-132 2xl:h-172 xl:w-7/12 rounded-4xl rounded-l-none border border-l-0 sepia-50 brightness-90"
        />
        <Image
          src="/images/right.jpg"
          alt="Pencils"
          layout="fullWidth"
          className="object-cover w-2/3 h-64 xl:h-96 2xl:h-124 xl:w-5/12 rounded-4xl rounded-r-none border border-r-0 sepia-50 brightness-90 contrast-125"
        />
      </div>
      ...
      <div className="flex flex-col xl:flex-row justify-between gap-16 xl:gap-0 p-4 xl:px-12 xl:py-36">
        <div className="space-y-36 xl:space-y-24">
          <div className="relative">
            <span className="text-8xl xl:text-[12rem] font-light leading-0">&ldquo;</span>
            ...
            <span className="absolute -top-2 xl:-top-5.5 left-0 w-xs xl:w-2xl text-2xl xl:text-4xl font-medium tracking-tighter">
              and creative approaches — pushing boundaries to make every story smarter, fresher, and
              more meaningful.
            </span>
          </div>
          <div className="inline-flex">
            ...
            <div className="pl-4 space-y-2">
              <div className="text-orange-500 text-sm tracking-tight">MetaPress</div>
              <div>
                <div className="text-2xl font-medium tracking-tighter">Dhruv Jangid</div>
        ...
        <div className="grid grid-cols-2 gap-8 xl:gap-24 xl:-mt-18 xl:pr-16">
          <div className="space-y-4 xl:space-y-8 border-b pb-12 xl:pb-24">
            ...
            <div className="text-sm max-w-3xs text-balance">
              Our growing community of readers who engage with fresh stories and insights every day.
            </div>
          </div>
          <div className="space-y-4 xl:space-y-8 border-b pb-12 xl:pb-24">
            <div className="flex gap-4 xl:gap-8">
            ...
            <div className="text-sm max-w-3xs text-balance">
              From deep dives to creative essays — a reflection of our passion for storytelling and
              sharing ideas.
            </div>
          </div>
          <div className="space-y-4 xl:space-y-8 border-b pb-12 xl:pb-24">
            ...
            <div className="text-sm max-w-3xs text-balance">
              Most of our posts are built from authentic experiences, thoughts, and perspectives —
              no AI fluff, just real voices.
            </div>
          </div>
          <div className="space-y-4 xl:space-y-8 border-b pb-12 xl:pb-24">
            <div className="flex gap-4 xl:gap-8">
            ...
            <div className="text-sm max-w-3xs text-balance">
              A vibrant network of contributors, editors, and creatives shaping our platform
              together.
            </div>
          </div>
        </div>
