    ...
    <div className="h-dvh w-full overflow-hidden">
      ...
      <div className="h-full">
        <div className="text-9xl w-fit ml-12 lg:ml-32 xl:ml-48 font-medium">
          <div className="tracking-tighter text-primary">ERROR</div>
        ...
        <div className="text-2xl lg:text-xl xl:text-5xl text-muted-foreground mt-14 tracking-tight">
          SOMETHING WENT SIDEWAYS IN THE LAB. WE DIDN&apos;T BREAK ANY MACHINES (PROBABLY), BUT THIS
          EXPERIMENT DIDN&apos;T GO AS PLANNED. YOU CAN TRY AGAIN, HEAD BACK TO THE HOMEPAGE, OR
          CONTACT US BEFORE THE BEAKERS BOIL OVER.
        </div>
      </div>
    </div>
  );
